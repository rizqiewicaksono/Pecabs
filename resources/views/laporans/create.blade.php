                            ...
                            <div class="card-body">
                                 <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" required>
                                        <option value="0" {{ old('status') == '0' ? 'selected':'' }}>Belum Terverifikasi</option>
                                        @if(auth()->user()->role == 'Dinas Pariwisata')
                                        <option value="1" {{ old('status') == '1' ? 'selected':'' }}>Terverifikasi</option>
                                        @endif
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="image">Foto Laporan</label>
